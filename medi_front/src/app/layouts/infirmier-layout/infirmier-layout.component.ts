...
@Component({
  ...
  template: `
    <div class="shell" style="--role-accent:#2B6CB0">
      <aside class="sidebar">
        <div class="brand">
        ...
        <span class="role-tag">Infirmier(e)</span>

        <nav class="nav">
          <a routerLink="/infirmier/historique" routerLinkActive="is-active" class="nav-link">Historique des patients</a>
          <a routerLink="/infirmier/patient-create" routerLinkActive="is-active" class="nav-link">Nouveau patient</a>
        </nav>
