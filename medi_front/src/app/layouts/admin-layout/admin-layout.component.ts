...
@Component({
  ...
  template: `
    <div class="shell" style="--role-accent:#C97F1B">
      <aside class="sidebar">
        <div class="brand">
        ...
        <nav class="nav">
          <a routerLink="/admin/specialites" routerLinkActive="is-active" class="nav-link">Spécialités</a>
          <a routerLink="/admin/medecins" routerLinkActive="is-active" class="nav-link">Médecins</a>
          <a routerLink="/admin/utilisateurs" routerLinkActive="is-active" class="nav-link">Utilisateurs</a>
          <a routerLink="/admin/historique" routerLinkActive="is-active" class="nav-link">Historique</a>
        </nav>
